 ...
 *@param numberOfDecorations int  
 *@param section NodeList  
 *@param cercles Array  
 *@param vLignes Array  
 *=============================================**/
function aligneDeco(numberOfDecorations, section, cercles, vLignes) {
	let totalHauteur = 26,
		cerclesCompteur = 0,
		vLignesCompteur = 1;

	for (element = 0; element <= numberOfDecorations; element++) {
		if (estPair(element) == true) {
			...
			if (element === numberOfDecorations) {
